...
@Service
public class EmailServiceRegist {

    @Autowired
    private JavaMailSender javaMailSender;

    public void sendOTPRegist(String toEmail, String otp, String nama) {
        ...
        try {
            ...
            helper.setSubject("Verification your OTP code for Registration");
